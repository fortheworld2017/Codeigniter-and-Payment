...
<?php 
	//echo "<div style = \"background-color:#f1f1f1; padding:5px; border:1px solid #ccc\">";
  //print_r($template_details);//templateName
  //echo "</div>";
	$attributes = array('name' => 'template_form', 'id' => 'template_form', 'enctype' => 'multipart/form-data');
	echo form_open(base_url('editbusinesscard/edit/'.$id), $attributes);?>
  ...
  ?>			
      ...
      <!-- Utilities -->
                  ...
                  <div class="col-sm-5" id = "card_content_social_part_three" style = "display:none">
                     ...
                     <div class="checkbox">
                        <label>
                          <input <?php if($googlePlusSelected==1) { ?>checked="checked"<?php } ?> type="checkbox" id ="playStoreSelected" name = "googlePlusSelected" value = "1" >&nbsp;&nbsp;<i class="fa fa-google-plus-square fa-lg fa-fw"></i> Google+
                        </label>
                      </div>
                  </div>
                  ...
                  <div class="col-sm-5" id = "card_content_contact_part_two">
                      ...
                      <div class="checkbox">
                        <label>
                          <input <?php if($appStoreSelected==1) { ?>checked="checked"<?php } ?> type="checkbox" id ="appStoreSelected"  value = "1">&nbsp;&nbsp;<i class="fa fa-apple fa-lg fa-fw"></i> Apple App Store
                        </label>
                      </div>
                     <div class="checkbox">
                        <label>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="input-group">
                      <input type="text" class="form-control" id = "template_name" name = "templateName" value = "<?php echo html_escape($template_details[0]->templateName);?>">
