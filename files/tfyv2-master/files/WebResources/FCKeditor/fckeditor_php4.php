...
class FCKeditor
{
	...
	function FCKeditor( $instanceName )
	{
		...
		$this->Width		= '100%' ;
		$this->Height		= '400' ;
		$this->ToolbarSet	= 'ContentManagement' ;
		$this->Value		= '' ;
	...
	function CreateHtml()
	{
		...
		if ( $this->IsCompatible() )
		{
			...
			$Html .= "<iframe tabindex=\"{$this->TabIndex}\" id=\"{$this->InstanceName}___Frame\" src=\"{$Link}\" width=\"{$this->Width}\" height=\"{$this->Height}\" frameborder=\"0\" scrolling=\"no\"></iframe>" ;
		}
		else
		{
